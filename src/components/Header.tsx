    ...
    <header className="border-b border-[#e7e9ee] bg-white">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-6 py-4">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-md bg-[#0b8bd3] text-white">
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
              ...
              aria-hidden="true"
            >
              <path d="M3 12l7-7 4 4-7 7H3v-4z" />
              <path d="M14 5l5 5" />
            </svg>
          </div>
          <span className="text-base font-semibold text-[#111827]">Your Logo</span>
        </div>
